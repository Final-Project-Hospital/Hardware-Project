    ...
    return (
        <div className='card my-4 shadow-md sm:rounded-lg bg-white'>
            <div className='flex items-center justify-between px-5 py-5 pb-0'>
                <h2 className="text-[18px] font-[700]">Temperature and Humidity Data Chart</h2>
            </div>

            <div className='flex items-center gap-5 px-5 py-5 pt-2'>
                <span className='flex items-center gap-1 text-[15px]'><span className='block w-[8px] h-[8px] rounded-full bg-red-400'></span>Tempreture</span>
                <span className='flex items-center gap-1 text-[15px]'><span className='block w-[8px] h-[8px] rounded-full bg-blue-400'></span>Humidity</span>
            </div>
